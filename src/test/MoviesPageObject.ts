...
class PageObject {
    ...
    private formFields = ['Title', 'Duration', 'Year', 'Director', 'Starring', 'Description', 'Url']

    async waitUntilAMovieItemIsDisplayed(){
        await screen.findAllByTestId(/movie-item-/)
    }
    ...
    fillNewMovieForm(formData: Partial<Record<"Title" | "Duration" | "Year" | "Director" | "Starring" | "Description" | "Url", string>>){
